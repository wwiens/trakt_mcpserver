...
class TestFormatHelper:
    ...
    def test_format_device_auth_instructions(self):
        ...
        result = FormatHelper.format_device_auth_instructions(
    ...
    def test_format_comments(self):
        ...
        result = FormatHelper.format_comments(
            sample_data, "Breaking Bad", show_spoilers=False
        )
        ...
        result = FormatHelper.format_comments(
            sample_data, "Breaking Bad", show_spoilers=True
        )
