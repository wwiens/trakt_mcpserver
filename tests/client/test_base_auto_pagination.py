...
async def test_auto_paginate_single_page():
    ...
    with (
        ...
        result = await client.auto_paginate(
            "/test/endpoint", response_type=TestResponse, params={"limit": 2}
        )
...
async def test_auto_paginate_empty_results():
    ...
    with (
        ...
        client = TestableClient()
        result = await client.auto_paginate(
            "/test/endpoint", response_type=TestResponse, params={"limit": 10}
        )
...
async def test_auto_paginate_uses_server_next_page():
    ...
    with (
        ...
        client = TestableClient()
        result = await client.auto_paginate(
            "/test/endpoint", response_type=TestResponse, params={"limit": 1}
        )
...
async def test_auto_paginate_with_none_params():
    ...
    with (
        ...
        client = TestableClient()
        result = await client.auto_paginate(
            "/test/endpoint", response_type=TestResponse, params=None
        )
